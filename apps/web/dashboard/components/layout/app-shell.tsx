    ...
    <div className="flex h-dvh overflow-hidden bg-[#f7f7f6] text-[#202124]">
      ...
      <section className="flex min-w-0 flex-1 flex-col">
        <header className="relative z-30 flex h-[52px] shrink-0 items-center bg-[#30302f] px-3 text-white">
          ...
          <div className="ml-auto flex items-center gap-1"><button aria-label="Notifications — bientôt disponible" title="Notifications — bientôt disponible" disabled className="cursor-not-allowed rounded p-2 text-white/45"><Bell size={18} /></button><div className="ml-1 flex h-8 w-8 items-center justify-center"><UserButton /></div></div>
        </header>
