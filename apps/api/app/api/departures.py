...
class Create(BaseModel):shipping_service_id:str;departure_code:str|None=None;scheduled_at:datetime;cutoff_at:datetime|None=None;estimated_arrival_at:datetime|None=None;capacity_weight_kg:float|None=Field(default=None,gt=0);capacity_cbm:float|None=Field(default=None,gt=0);carrier_name:str|None=None;transport_reference:str|None=None;notes:str|None=None
