...
export async function approveCopilotWorkflow(workflowId: string) {
  return (await api.post<{workflow:CopilotWorkflow;result?:{client?:Record<string,unknown>;dossier?:Record<string,unknown>;package?:Record<string,unknown>;followup?:Record<string,unknown>}}>(`/ai/copilot/workflows/${workflowId}/approve`)).data;
}
