...
def test_transversal_read_tools_are_checked_before_action_workflows():
    ...
    for capability in ("operations.overview","clients.search","packages.list","dossiers.list","tracking.read","routes.list","services.list","services.recommend","warehouses.list",
